...
public class UsernameEmBranco {
	...
	public void before() throws IOException, SQLException, ParseException {
		...
		leitorMassa.leitorJson("UsernameEmBranco");
	}

	@Test
	public void loginUsernameEmBranco() {

		try {
			login.diretorio = "UsernameEmBranco";
			...
			login.efetuaLogin();
			Assert.assertEquals(true, login.usernameEmBranco());
