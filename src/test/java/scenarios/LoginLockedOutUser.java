...
public class LoginLockedOutUser {
	...
	public void before() throws IOException, SQLException, ParseException {
		...
		leitorMassa.leitorJson("LoginLockedOutUser");
	}
	...
	public void loginLockedOutUser() {
		...
		try {
			login.diretorio = "LoginLockedOutUser";
			...
			login.efetuaLogin();
			Assert.assertEquals(true, login.loginBloqueado());
