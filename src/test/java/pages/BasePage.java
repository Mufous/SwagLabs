...
public class BasePage {
	...
	public void screenShot(String nomeMetodo, String diretorio) throws IOException {
		...
		FileUtils.copyFile(arquivo, new File("output" + File.separator + diretorio + File.separator + nomeMetodo +"_screenshot.jpg")); // o File.separator
